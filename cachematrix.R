...
## If no argument is given, the defualt is an empty matrix. The overarching goal 
## of this function is to calculate and store the inverse of x, which is does 
...
## will assign to a variable, inverse, the 'getInverse' value found in x. 
...
cacheSolve <- function(x, ...) {
    ...
    ## whatever the 'getInverse' found in x equals
